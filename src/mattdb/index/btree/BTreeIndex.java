...
import mattdb.query.StringConstant;
...
public class BTreeIndex implements Index {
     ...
     * and getDataRid.
     *
     * @see mattdb.index.Index#beforeFirst(mattdb.query.Constant)
     */
     ...
     *
     * @see mattdb.index.Index#getDataRid()
     */
     ...
     *
     * @see mattdb.index.Index#insert(mattdb.query.Constant, mattdb.record.RID)
     */
     ...
     *
     * @see mattdb.index.Index#delete(mattdb.query.Constant, mattdb.record.RID)
     */
