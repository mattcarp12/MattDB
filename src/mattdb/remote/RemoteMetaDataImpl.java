...
public class RemoteMetaDataImpl extends UnicastRemoteObject implements RemoteMetaData {
     ...
     *
     * @see mattdb.remote.RemoteMetaData#getColumnCount()
     */
     ...
     *
     * @see mattdb.remote.RemoteMetaData#getColumnName(int)
     */
     ...
     *
     * @see mattdb.remote.RemoteMetaData#getColumnType(int)
     */
     ...
     *
     * @see mattdb.remote.RemoteMetaData#getColumnDisplaySize(int)
     */
