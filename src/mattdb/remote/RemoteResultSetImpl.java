...
class RemoteResultSetImpl extends UnicastRemoteObject implements RemoteResultSet {
    ...
    * @see mattdb.remote.RemoteResultSet#next()
    */
    ...
    * @see mattdb.remote.RemoteResultSet#getInt(java.lang.String)
    */
    ...
    * @see mattdb.remote.RemoteResultSet#getMetaData()
    */
    ...
    * @see mattdb.remote.RemoteResultSet#close()
    */
